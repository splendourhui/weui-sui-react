...
var SUIHeader = (function (_Component) {
  _inherits(SUIHeader, _Component);

  function SUIHeader(props) {
    _classCallCheck(this, SUIHeader);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SUIHeader).call(this, props));
  }

  _createClass(SUIHeader, [{
    key: 'render',
